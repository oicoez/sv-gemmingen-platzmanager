...
async function initDb(){
  ...
  console.log("ClubPlanner 4.0 Phase 1 Datenbankstruktur ist bereit.");
}
...
initDb().then(()=>app.listen(PORT,"0.0.0.0",()=>console.log(`ClubPlanner 4.0 Phase 1 läuft auf Port ${PORT}`)))
