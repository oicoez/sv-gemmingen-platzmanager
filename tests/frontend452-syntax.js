...
async function buildPrintMonth(ym,from,to){
 ...
 return `<section class="printPage weeks${weekRows}">
...
header{height:13mm;display:flex;justify-content:space-between;align-items:center;border-bottom:1.2mm solid #1f4e78;margin:0 0 2mm;padding:0 1mm}
h1{font-size:14pt;margin:0}header div{font-size:12pt;font-weight:700}
.pgrid{height:176mm;display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:1mm;align-content:stretch}
...
.pday{
 border:.35mm solid #aebdcb;padding:1mm;font-size:6.4pt;line-height:1.18;overflow:hidden;
 background:#fff;min-width:0;min-height:0
}
.pday.blank,.pday.mutedday{background:#f5f6f7!important}
.pnum{font-weight:800;font-size:7.2pt;margin-bottom:.7mm}
.pitem{
 border-left:1.1mm solid var(--item-color,#607d94);border-radius:1.2mm;padding:.8mm;margin:.55mm 0;
 line-height:1.18;overflow:hidden;background:var(--item-color,#f5f7f9)!important;
 -webkit-print-color-adjust:exact!important;print-color-adjust:exact!important
}
.pitem.conflict{background:#ffeaea!important;border-left-color:#c62828!important}
.pmanual{display:inline-block;font-weight:800;border:.25mm solid #b68b00;border-radius:5mm;padding:0 .8mm;background:#fff3cd!important}
.pred{color:#b42318}
footer{height:5mm;display:flex;justify-content:flex-end;align-items:end;font-size:6.2pt;color:#66727e;padding-right:1mm}
@media print{
